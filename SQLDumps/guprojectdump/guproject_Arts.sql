...
CREATE TABLE `Arts` (
  `idArts` int(11) NOT NULL auto_increment,
...
INSERT INTO `Arts` VALUES (1,'Performing Arts'),(2,'Theatre'),(3,'Museums'),(4,'Dance'),(5,'Circus'),(6,'Opera'),(7,'Galleries');
...
-- Dump completed on 2014-02-23 17:16:14
